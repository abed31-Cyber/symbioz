...
@section('content')
    ...
    <section class="bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
            <div class="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
                <div class="bg-gradient-to-br from-brand-light to-gray-100 rounded-2xl h-72 flex items-center justify-center text-brand/40">
                    <span class="text-sm">Photo équipe</span>
                </div>
